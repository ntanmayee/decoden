...
def extract_mixing_matrix(data_df, conditions_list, conditions_counts_ref, alpha_W=0.01, alpha_H=0.001,
    ...
    mixing_matrix, signal_matrix = relax_mixing_matrix(mixing_matrix, signal_matrix)
